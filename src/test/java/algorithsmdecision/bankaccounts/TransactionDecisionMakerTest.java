package algorithsmdecision.bankaccounts;

import algorithmsdecision.bankaccounts.Transaction;
import algorithmsdecision.bankaccounts.TransactionDecisionMaker;
import algorithmsdecision.bankaccounts.TransactionOperation;
...
public class TransactionDecisionMakerTest {
    ...
    public void testContainsCreditEntryGreaterReturnFalseBecauseOfMin() {
        ...
        TransactionDecisionMaker test = new TransactionDecisionMaker();
        assertFalse(test.containsDebitEntryGreaterThan(transactions, startTime, endTime, 200000));
