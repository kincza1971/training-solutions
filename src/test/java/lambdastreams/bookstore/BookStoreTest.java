...
public class BookStoreTest {
    ...
    public void initializeList() {
        ...
        books.add(new Book("Java in a Shell", 2009, 9500, 31));
        books.add(new Book("Java in a Kingshell", 2009, 9500, 31));
    ...
    public void getNumberOfBooks() {
        ...
        assertEquals(145, bookStore.getNumberOfBooks());
    }
    ...
    public void getTotalValue() {
        ...
        assertEquals(1_132_900, bookStore.getTotalValue());
    }
    ...
    @Test
    public void getBooksByYearOfPublishTest() {
        BookStore bookStore = new BookStore(books);
        System.out.println(bookStore.getBooksByYearOfPublish(2009));
    }
}